...
_STRINGS = {
    "welcome_new": {
        "en": "Welcome! You need to login an account first.\n\nEnter phone number (e.g. +628123456789):",
        "id": "Selamat datang! Kamu perlu login akun dulu.\n\nMasukkan nomor HP (contoh: +628123456789):",
    ...
    "enter_phone": {
        "en": "Enter phone number (e.g. +628123456789):",
        "id": "Masukkan nomor HP (contoh: +628123456789):",
